...
@WebServlet(name = "SendDeleteNotificationUser", urlPatterns = {"/SendDeleteNotificationUser"})
public class SendDeleteNotificationUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            String adminEmail = requestJson.get("userEmail").getAsString();

            String subject = "Account Deleted - Clay Bricks User";
            String content = "<!DOCTYPE html><html><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>"
                ...
                + "</style></head><body>"
                + "<div class='container'>"
                + "<div class='header'><h1>Clay Bricks Platform</h1></div>"
                + "<div class='content'>"
                ...
                + "Your user account has been permanently removed from the Clay Bricks system."
                + "</p>"
                + "</div>"
                + "<p style='color: #666; margin-top: 20px;'>This action is irreversible. If this was unexpected, please contact our support team.</p>"
                + "</div>"
                + "<div class='footer'>"
